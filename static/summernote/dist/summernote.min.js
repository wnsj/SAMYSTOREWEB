				...
				return e = t, (n = [{
					...
					value: function() {
						...
						var o = this.options.dialogsInBody ? this.$body : this.options.container,
							i = [
								'<div class="form-group note-group-image-url" style="height:34px;">', 
								'<label for="note-dialog-image-url-' 
								+ this.options.id +
								'" class="note-form-label" style="width:88px; float:left; line-height:34px;">' 
								+ this.lang.image.url + 
								":</label>", 
								'<input id="note-dialog-image-url-' 
								+ this.options.id + 
								'" class="note-image-url form-control note-form-control note-input" style="width:400px; float:left;" type="text"/>',
								"</div>",
								'<div class="form-group note-form-group note-group-select-from-files" style="height:250px;">',
								'<div style="width:50%;height:250px; float:left;">',
								'<div style="position:relative;height:34px;margin-bottom:15px">',
								'<label style="width:88px; float:left; line-height:34px; margin-bottom:0">图片宽度:</label>',
								'<input id="note-dialog-image-url-' 
								+ this.options.id + 
								'" class="note-image-width form-control note-form-control note-input" style="width:88px; float:left;" type="text"/>',
								'<b style="position:absolute; left:150px;line-height:34px;">px</b>',
								'</div>',
								'<div style=" position:relative;height:34px;margin-bottom:15px">',
								'<label style="width:88px; float:left; line-height:34px; margin-bottom:0">图片高度:</label>',
								'<input id="note-dialog-image-url-' 
								+ this.options.id + 
								'" class="note-image-height form-control note-form-control note-input" style="width:88px; float:left;" type="text"/>',
								'<b style="position:absolute; left:150px;line-height:34px;">px</b>',
								'</div>',
								'</div>',
								'<div style="position:relative;width:234px;height:250px; float:left;">',
								'<div class="showImg"></div>',
								'<input id="note-dialog-image-file-' 
								+ this.options.id +
								'" class="note-image-input form-control-file note-form-control note-input" ',
								' type="file" name="files" accept="image/*" style="position:absolute;left:0;top:0;width:100%;height:100%; display:block; opacity:0;" multiple="multiple"/>', 
								'</div>',
								t, 
								"</div>",
							].join(""),
					...
					value: function() {
						...
						return i.a.Deferred((function(e) {
							var n = t.$dialog.find(".note-image-input"),
								...
								showimg = t.$dialog.find(".showImg"),
								imgwid = t.$dialog.find(".note-image-width"),
								imghei = t.$dialog.find(".note-image-height"),
								inputurl="";
							t.ui.onDialogShown(t.$dialog, (function() {
								...
								n.replaceWith(n.clone().on("change", (function(t) {
									...
									reader.onloadend = function() {
										showimg.css({'background-image':'url('+reader.result+')','background-size':'contain'});
										i.attr('disabled',false);
										inputurl = reader.result;
									}
								...
								(function() {
									...
									showimg.css({'background-image':'url('+o.val()+')','background-size':'contain'});
								})).val(""),
								...
								i.click((function(t) {
									...
									if(inputurl){
										e.resolve(inputurl,imgwid.val(),imghei.val())
										console.log(e);
									}else if(o.val()){
										t.preventDefault(), e.resolve(o.val(),imgwid.val(),imghei.val())
									}
									showimg.css({'background-image':'url(../../../static/img/image.png)','background-size':'auto'});
			...
			var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
				...
				y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t,
					...
					e.fade && t.addClass("fade"), t.attr({
						"aria-label": e.title
					}), t.html(['<div class="modal-dialog" style="width:90%;height:90%;margin:5% auto;">', '<div class="modal-content"  style="width:100%;min-height:100%">', e.title ?
