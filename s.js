	...
	return function(t) {
		...
		3 : function(t, e, n) {
			...
			var x = {
				...
				all: function(t, e) {
					for (var n = 0,
					o = t.length; n < o; n++) if (!e(t[n])) return ! 1;
					return ! 0
				},
				sum: function(t, e) {
					return e = e || b.self,
			...
			function ut(t, e) {
				if (t && t.parentNode) {
					...
					if (!e) {
						...
						for (var a = 0,
						s = o.length; a < s; a++) n.insertBefore(o[a], t)
					}
					n.removeChild(t)
				}
			}
			...
			var ft = {
				...
				listDescendant: function(t, e) {
					...
					function o(i) {
						t !== i && e(i) && n.push(i);
						for (var r = 0,
						a = i.childNodes.length; r < a; r++) o(i.childNodes[r])
					} (t),
					n
				},
				...
				fromOffsetPath: function(t, e) {
					for (var n = t,
					o = 0,
					i = e.length; o < i; o++) n = n.childNodes.length <= e[o] ? n.childNodes[n.childNodes.length - 1] : n.childNodes[e[o]];
					return n
				},
				splitTree: lt,
			...
			var mt = function() {
				...
				},
				{
					...
					value: function() {
						...
						var n = i.a.extend({},
						this.options.modules, i.a.summernote.plugins || {});
			...
			i.a.fn.extend({
				summernote: function() {
					...
					n = "object" === t,
					o = i.a.extend({},
					i.a.summernote.options, n ? x.head(arguments) : {});
					o.langInfo = i.a.extend(!0, {},
					i.a.summernote.lang["en-US"], i.a.summernote.lang[o.lang]),
					o.icons = i.a.extend(!0, {},
					i.a.summernote.options.icons, o.icons),
			...
			var yt = function() {
				...
				},
				{
					...
					value: function() {
						if (ft.isBodyContainer(this.sc) && ft.isEmpty(this.sc)) return this.sc.innerHTML = ft.emptyPara,
				...
				},
				{
					key: "insertNode",
					value: function(t) {
						var e = this; (ft.isText(t) || ft.isInline(t)) && (e = this.wrapBodyInlineWithPara().deleteContents());
			...
			var Pt = function() {
				...
				(n = [{
					key: "insertTab",
					value: function(t, e) {
						var n = ft.createText(new Array(e + 1).join(ft.NBSP_CHAR)); (t = t.deleteContents()).insertNode(n, !0),
			...
			var Lt = function t(e, n, o, i) {
				...
				function() {
					for (var t = i.rows,
					e = 0; e < t.length; e++) for (var n = t[e].cells, o = 0; o < n.length; o++) d(t[e], n[o])
				} ()
			}; Lt.where = {
				Row: 0,
				Column: 1
			...
			var Dt = function() {
				...
				},
				{
					...
					value: function(t) {
						...
						if ("TAB" !== o || this.options.tabDisable) if (i) {
							if (!1 !== this.context.invoke(i)) return t.preventDefault(),
							!0
				...
				},
				{
					...
					value: function(t) { (t.ctrlKey || t.metaKey) && x.contains([66, 73, 85], t.keyCode) && t.preventDefault()
					}
				},
				{
					key: "isLimited",
				...
				},
				{
					...
					value: function() {
						var t = this.getLastRange();
						if (t.isOnAnchor()) {
							var e = ft.ancestor(t.sc, ft.isAnchor); (t = kt.createFromNode(e)).select(),
							this.setLastRange(),
							this.beforeCommand(),
			...
			var Mt, Ot = function() {
				...
				},
				{
					...
					value: function() {
						...
						this.documentEventHandlers.onDragleave = function(n) { (e = e.not(n.target)).length && "BODY" !== n.target.nodeName || (e = i()(), t.$editor.removeClass("dragover"))
						},
			...
			var se = function() {
				...
				},
				{
					...
					value: function() {
						...
						l = s - r,
						c = s + t - r - n - o; ! this.isFollowing && a > l && a < c - n ? (this.isFollowing = !0, this.$editable.css({
			...
			var Te = function() {
				...
				},
				{
					...
					value: function(t, e) {
						...
						return this.searchKeyword(t, e, (function(e) { (e = e || []).length && (o.html(n.createItemTemplates(t, e)), n.show())
						})),
						o
					}
				},
						...
						if (!x.contains([Ct.code.ENTER, Ct.code.UP, Ct.code.DOWN], t.keyCode)) {
							...
							if ("words" === this.options.hintMode) {
								if (n = r.getWordsRange(r), o = n.toString(), this.hints.forEach((function(t) {
									if (t.match.test(o)) return n = r.getWordsMatchRange(t.match),
									!1
								})), !n) return void this.hide();
								o = n.toString()
							} else n = r.getWordRange(),
							o = n.toString();
					...
					palette: function(e, n) {
						return r.a.create('<div class="note-color-palette"/>', (function(e, n) {
							for (var o = [], i = 0, r = n.colors.length; i < r; i++) {
								for (var a = n.eventName,
								s = n.colors[i], l = n.colorsName[i], c = [], u = 0, d = s.length; u < d; u++) {
									var h = s[u],
									f = l[u];
