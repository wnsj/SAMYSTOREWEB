		...
		<div class="row newRow" style="padding-bottom:15px;">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				<div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
					<p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">主题分类</p><span class="sign-left">:</span>
				</div>
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				<div class="col-md-5 col-lg-5 text-right" style="padding: 0; line-height: 34px;">
					<p class="end-aline col-md-11 col-lg-11" style="padding-right:5px; padding-left:20px;">文章类型</p><span class="sign-left">:</span>
				</div>
				<div class="col-md-7 col-lg-7">
					<ArticleTheme ref="atRef" @atChange="setAtData"></ArticleTheme>
				</div>
			...
			<button type="button" class="btn btn-warning pull-right m_r_10" style="margin-right:1.5%;" data-toggle="modal"
			 v-has="'Article:add'" v-on:click="selectRule('1')">添加</button>
